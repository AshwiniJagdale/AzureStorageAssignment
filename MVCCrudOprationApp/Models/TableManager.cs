...
namespace MVCCrudOprationApp.Models
{
    public class TableManager
    {
        ...
        public TableManager(string _CloudTableName)
        {
            ...
            try
            {
                string ConnectionString = "DefaultEndpointsProtocol=https;AccountName=ashwinitjstorage;AccountKey=SM/Na8kv2Ar0q3AS5X+HU6AFXeJ2/YFIhifr6U3tG3vM4T89QAxLGDfl41z6VIaBd0DVsDRLpeTZuwysSjBMOg==;EndpointSuffix=core.windows.net";
